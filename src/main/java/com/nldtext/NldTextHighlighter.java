...
import com.nldtext.NldTextFieldMapper.AnnotatedHighlighterAnalyzer;
import com.nldtext.NldTextFieldMapper.AnnotatedText;
...
public class NldTextHighlighter extends UnifiedHighlighter {
    ...
    protected List<Object> loadFieldValues(
        ...
        ((NldPassageFormatter) highlighter.getFormatter()).setAnnotations(annotations);
    ...
    protected PassageFormatter getPassageFormatter(HitContext hitContext, SearchHighlightContext.Field field, Encoder encoder) {
        return new NldPassageFormatter(encoder);
    }
