...
import com.nldtext.NldTextFieldMapper.AnnotatedText.AnnotationToken;
 ...
 */
public class NldPassageFormatter extends PassageFormatter {

    public static final String SEARCH_HIT_TYPE = "_hit_term";
    private final Encoder encoder;
    AnnotatedText[] annotations;

    public NldPassageFormatter(Encoder encoder) {
    ...
    public Snippet[] format(Passage[] passages, String content) {
        ...
        for (Passage passage : passages) {
            ...
            for (Markup markup : mergedMarkup.markups) {
                ...
                if (end > pos) {
                    sb.append("<b data=\"" + markup.metadata + "\">");
